package com.alexandre.Todo_SpringBoot.config;

import com.alexandre.Todo_SpringBoot.enums.UserRole;
import com.alexandre.Todo_SpringBoot.services.jwt.UserService;
...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable) // The same with http.csrf().disable()
